...
public class GestionReservation extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        retournerButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                retournerButtonMouseClicked(evt);
            }
        });
   ...
   public boolean getCodeBarValidation() throws SQLException{
    ...
    public boolean getRecordValidation() throws SQLException{ 
            ...
            if(reservationController.getValidation().isEmpty(dateDebutTxt.getDate().toString())){
                JOptionPane.showMessageDialog(rootPane, "plz enter the date debut ");
                dateDebutTxt.requestFocus();
                return false; 
          }else if(reservationController.getValidation().isEmpty(cinTxt.getText().trim())){
          ...
          int nbrPenalite = reservationController.getDao().checkUserPenalite(cinTxt.getText());
               if(nbrPenalite>0){
    ...
    private void retournerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_retournerButtonActionPerformed
        if(tblDisplay.getSelectedRow() == -1 ) {
          ...
          int isReturned =  Integer.parseInt(  tblDisplay.getValueAt(tblDisplay.getSelectedRow(), 9).toString()) ;
          if(isReturned == 0){
                gestionAmende(idRes);
                reservationController.getReservation().setIdRes(idRes);
                try{
                        reservationController.getDao().updateReturnedValue(idRes);
                   }catch(SQLException e) 
                   { JOptionPane.showMessageDialog(rootPane, e); }
                     JOptionPane.showMessageDialog(rootPane, "documents retourné avec succes");
                 initTable();  
               }else{
                     JOptionPane.showMessageDialog(rootPane, "le document est deja exist");
               } 
    ...
    private void retournerButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_retournerButtonMouseClicked
        // TODO add your handling code here:


    }//GEN-LAST:event_retournerButtonMouseClicked
